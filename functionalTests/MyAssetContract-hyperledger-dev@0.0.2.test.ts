...
// node_modules/.bin/mocha functionalTests/MyAssetContract-hyperledger-dev@0.0.2.test.ts --grep="myAssetExists" -r ts-node/register
...
describe('MyAssetContract-hyperledger-dev@0.0.2' , () => {
    ...
    describe('readMyAsset', () => {
        it('should submit readMyAsset transaction', async () => {
            ...
            // submitTransaction returns buffer of transcation return value
            assert.notStrictEqual(JSON.parse(response.toString()), null);
        }).timeout(10000);
    });
